...
class BetterLife extends StatefulWidget {
  const BetterLife({
    super.key,
  });

  @override
  State<BetterLife> createState() => _BetterLifeState();
}

class _BetterLifeState extends State<BetterLife> {
  var uid = FirebaseAuth.instance.currentUser!.uid;
  final fbUrl = Uri.parse(
      'https://www.facebook.com/BetterLifeSuperMarket?mibextid=ZbWKwL');
  final locationUrl = Uri.parse('https://maps.app.goo.gl/q8BQHbxmPun8HSLZ7');
                    ...
                    Container(
                      ...
                      decoration: const BoxDecoration(
                        ...
                        image: DecorationImage(
                          ...
                          // image: AssetImage('lib/src/assets/BetterLife.jpeg'),
                          fit: BoxFit.fill,
                        ),
                      ),
                    ),
