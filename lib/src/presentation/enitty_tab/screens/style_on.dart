...
class StyleOn extends StatefulWidget {
  const StyleOn({
    super.key,
  });

  @override
  State<StyleOn> createState() => _StyleOnState();
}

class _StyleOnState extends State<StyleOn> {
  var uid = FirebaseAuth.instance.currentUser!.uid;
  final fbUrl =
      Uri.parse('https://www.facebook.com/StyleOnKochi?mibextid=ZbWKwL');
  final locationUrl = Uri.parse('https://maps.app.goo.gl/8CG7K1hBvJfVgPyr6');
